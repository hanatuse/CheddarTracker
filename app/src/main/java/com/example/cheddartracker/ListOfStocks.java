...
import com.example.cheddartracker.auxelements.SaveAppPreferences;
...
public class ListOfStocks  extends AppCompatActivity implements StockAdapter.ItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button viewPortfolio = findViewById(R.id.viewPortfolio);
...
//        });
        ...
        addPosition.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                // Pull up entry form when the button is clicked
        ...
        viewPortfolio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Display data visualization when the button is clicked
                startActivity(new Intent(ListOfStocks.this, ProfitVisual.class));
            }
        });
