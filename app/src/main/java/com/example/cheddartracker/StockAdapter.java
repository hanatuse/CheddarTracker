...
public class StockAdapter extends RecyclerView.Adapter<StockAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        String buyPrice = String.valueOf(mData.get(position).getAcquisitionPrice());
        String sellPrice = String.valueOf(mData.get(position).getLastStockPrice());
        ...
        holder.buyPrice.setText(buyPrice);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        TextView stockName, buyPrice, sellPrice, stockGains;

        ViewHolder(View itemView) {
            super(itemView);
            stockName = itemView.findViewById(R.id.stock_name);
            buyPrice = itemView.findViewById(R.id.stock_buy_price);
            sellPrice = itemView.findViewById(R.id.stock_sell_price);
