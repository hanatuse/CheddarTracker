package com.example.cheddartracker.external;
...
5. The Last Stock Price from the stock Market (Usually fetched from the public API. Manually input for now)
6. Stock Name (usually fetched from the public API)
7. Last Updated date by the API
8. Fees (Commission per transaction)
*
* */
